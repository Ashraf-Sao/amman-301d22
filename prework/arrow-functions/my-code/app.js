...
// My refactoring //
let newSum = (num1, num2) => `${num1} + ${num2} = ${num1 + num2}`;
let newProduct = (num1, num2) => `${num1} * ${num2} = ${num1 * num2}`;

console.log(newSum(3, 9),newProduct(3, 9));
...
// it represnts the object that calls the function
// 2. What is "this" when joe.scopeArrow() is invoked?
// it represents the owner of the function which is Student
// 3. Explain why "this" is different when an arrow function is used.
// in arrow function "this" returns only the owner of the function, while in regular functions it returns -
// - all the objects in the constructor function
